...
| --- | --- | --- |
| 1 · Requests | — | the raw JSON. **500 customers** loads a realistic mixed list |
...
The 500-customer sample is generated by
...
that follow the specs people ask for. It groups into ~36 buckets in about 7 seconds.
Research is the expensive stage, so only the largest groups go to the web — the rest
are shown, waiting for more demand.
